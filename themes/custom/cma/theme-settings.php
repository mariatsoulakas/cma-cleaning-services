 ...
 */
function cma_form_system_theme_settings_alter(&$form, \Drupal\Core\Form\FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['cma_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('cma sample setting'),
  '#default_value' => theme_get_setting('cma_example'),
